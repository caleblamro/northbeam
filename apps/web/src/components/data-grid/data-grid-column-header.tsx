...
function DataGridColumnResizerImpl<TData, TValue>({
  ...
  return (
    <div
      ...
      tabIndex={0}
      className={cn(
        "absolute end-0 top-0 z-50 h-full w-0.5 cursor-ew-resize touch-none select-none bg-border transition-opacity after:absolute after:inset-y-0 after:end-0 after:h-full after:w-[18px] after:content-[''] hover:bg-primary focus:bg-primary focus:outline-none",
